...
mmerge vill_id hhold_id line_no using "P:\pop\BANGLADESH_PROJECT\MHSS2\Master Data\20160107_public\b3_spn", ukeep(spn06) uif(type=="B")
tab _merge
drop if _merge==2
...
gen m2_smoke_perday = spn06 if spn06~=. & spn06>0 // Ask randall why spn06cig doesnt exist 
...
gen 		m2_asthma_screen = cm34==1 if cm34~=.                            // cm34 does not exist
